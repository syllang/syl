...
pub struct ElaborationOutput {
    ...
    pub(super) map_ir: Option<MapIrStage>,
    pub(super) eir_build: Option<EirBuildStage>,
    pub(super) eir_validation: Option<EirValidationStage>,
    pub(super) eir_facts: Option<EirFactsStage>,
    pub(super) eir: Option<EirStage>,
    pub(super) driver_facts: Option<DriverFactsStage>,
    pub(super) drc: Option<DrcStage>,
    pub(super) metadata: Option<HardwareMetadata>,
    pub(super) hwir: Option<ParametricHwDesign>,
...
pub struct ConstMirStage {
    pub(super) program: ConstMirProgram,
}

impl ConstMirStage {
    pub(super) fn new(program: ConstMirProgram) -> Self {
        Self { program }
    }
...
pub struct MapIrStage {
    pub(super) program: MapIrProgram,
}

impl MapIrStage {
    pub(super) fn new(program: MapIrProgram) -> Self {
        Self { program }
    }
...
pub struct EirBuildStage {
    pub(super) design: Arc<EirRawDesign>,
}

impl EirBuildStage {
    pub(super) fn new(design: EirRawDesign) -> Self {
        Self {
...
impl EirValidationStage {
    pub(super) fn new(module_count: usize) -> Self {
        Self { module_count }
    }
...
pub struct EirFactsStage {
    pub(super) facts: Arc<EirDesignFacts>,
}

impl EirFactsStage {
    pub(super) fn new(facts: EirDesignFacts) -> Self {
        Self {
            facts: Arc::new(facts),
        }
    }
...
#[non_exhaustive]
pub struct EirStage {
    pub(super) design: EirDesign,
}

impl EirStage {
    pub(super) fn new(design: EirDesign) -> Self {
        Self { design }
    }
...
pub struct DriverFactsStage {
    pub(super) facts: DriverFacts,
}

impl DriverFactsStage {
    pub(super) fn new(facts: DriverFacts) -> Self {
        Self { facts }
    }
...
#[non_exhaustive]
pub struct DrcStage {
    pub(super) report: DriverDrcReport,
}

impl DrcStage {
    pub(super) fn new(report: DriverDrcReport) -> Self {
        Self { report }
    }
