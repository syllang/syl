...
use super::{
    body::{ElabExpr, ElabExprNode},
    item::{ElabBundleItem, ElabCallable, ElabConstItem, ElabEnumItem, ElabInterfaceItem},
};

#[non_exhaustive]
pub(crate) struct ElabProgram {
    pub(crate) defs: Vec<ElabDef>,
    pub(crate) canonical_paths: BTreeMap<DefId, HirPath>,
    pub(crate) visible_defs: BTreeMap<(DefId, String), DefId>,
    pub(crate) canonical_defs: BTreeMap<HirPath, DefId>,
    pub(crate) expr_resolutions_by_id: BTreeMap<(DefId, ExprId), ElabResolution>,
    pub(crate) extension_methods: HirExtensionMethodIndex,
    pub(crate) expr_types: BTreeMap<(DefId, ExprId), TirType>,
    pub(crate) local_types: BTreeMap<LocalId, TirType>,
    pub(crate) local_kinds: BTreeMap<LocalId, ElabLocalKind>,
    pub(crate) consts: BTreeMap<DefId, ElabConstItem>,
    pub(crate) enums: BTreeMap<DefId, ElabEnumItem>,
    pub(crate) enum_variants: BTreeMap<ElabEnumVariantKey, u64>,
    pub(crate) bundles: BTreeMap<DefId, ElabBundleItem>,
    pub(crate) interfaces: BTreeMap<DefId, ElabInterfaceItem>,
    pub(crate) callables: BTreeMap<DefId, ElabCallable>,
}
...
#[non_exhaustive]
pub(crate) struct ElabDef {
    pub(crate) name: String,
    pub(crate) kind: ElabDefKind,
}

#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord)]
#[non_exhaustive]
pub(crate) struct ElabEnumVariantKey {
    pub(crate) enum_def: DefId,
    pub(crate) name: String,
}

impl ElabEnumVariantKey {
    pub(crate) fn new(enum_def: DefId, name: impl Into<String>) -> Self {
        Self {
            enum_def,
            name: name.into(),
        }
...
impl From<&crate::source::HirEnumVariantKey> for ElabEnumVariantKey {
    fn from(value: &crate::source::HirEnumVariantKey) -> Self {
