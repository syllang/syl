...
use syl_sema::{
    CapabilityKind, ConstEvalError, ConstFactKey, DefinitionKind, DomainFact, HirFactId, Layout,
    LoweringError, ProtocolFieldDirection, SemanticCompiler, SemanticResolution,
    SemanticSourceFile, TirError, WordEncoding,
};
use syl_span::SourceId;
use syl_syntax::SourceParser;

#[path = "semantic_facts/software_structs.rs"]
mod software_structs;
#[path = "semantic_facts/support.rs"]
mod support;

use support::{ExprLookup, def_id, def_id_by_path, expr_id_at, local_id, parse_sources};
